...
template <int dim, typename Number, typename MemorySpace>
void
MGTransferMatrixFree<dim, Number, MemorySpace>::initialize_constraints(
  const MGConstrainedDoFs &mg_constrained_dofs)
{
...
template <int dim, typename Number, typename MemorySpace>
void
MGTransferMatrixFree<dim, Number, MemorySpace>::initialize_internal_transfer(
...
MGTransferMatrixFree<dim, Number, MemorySpace>::get_dof_handler_fine() const
{
  ...
  internal::loop_over_active_or_level_cells(
    dof_handler_in->get_triangulation(), level_in, [&](const auto &cell) {
      ...
      Assert(
        ...
        ExcMessage(
          "DoFHandler instances used for set up of MGTransferMatrixFree and copy_to_mg(), "
...
template <int dim, typename Number, typename MemorySpace>
void
MGTransferMatrixFree<dim, Number, MemorySpace>::build(
...
template <int dim, typename Number, typename MemorySpace>
void
MGTransferMatrixFree<dim, Number, MemorySpace>::prolongate(
...
template <int dim, typename Number, typename MemorySpace>
void
MGTransferMatrixFree<dim, Number, MemorySpace>::prolongate_and_add(
  const unsigned int to_level,
  VectorType        &dst,
  const VectorType  &src) const
{
...
template <int dim, typename Number, typename MemorySpace>
void
MGTransferMatrixFree<dim, Number, MemorySpace>::restrict_and_add(
...
template <int dim, typename Number, typename MemorySpace>
void
MGTransferMatrixFree<dim, Number, MemorySpace>::assert_dof_handler(
...
template <int dim, typename Number, typename MemorySpace>
std::size_t
MGTransferMatrixFree<dim, Number, MemorySpace>::memory_consumption() const
{
  std::size_t size = 0;
...
template <int dim, typename Number, typename MemorySpace>
inline unsigned int
MGTransferMatrixFree<dim, Number, MemorySpace>::min_level() const
{
...
template <int dim, typename Number, typename MemorySpace>
inline unsigned int
MGTransferMatrixFree<dim, Number, MemorySpace>::max_level() const
{
...
template <int dim, typename Number, typename MemorySpace>
inline void
MGTransferMatrixFree<dim, Number, MemorySpace>::clear()
{
