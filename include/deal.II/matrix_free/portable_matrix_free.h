...
namespace Portable
{
  ...
  public:
    ...
    struct AdditionalData
    {
       ...
       * gone through, otherwise the cells in the given level. This option has
       * no effect if the DoFHandler does not have level DoFs.
       */
    ...
    /**
     * Return the multigrid level that this object has been initialized with.
     * The level is `numbers::invalid_unsigned_int` for active cells.
     */
    unsigned int
    get_mg_level() const;
